...
const D_FAMILY = [
  { src: DA + "char-family-doodle.png",  left: 15.8, top: 47.1, w: 16.5, cls: "hero" },
  { src: DA + "char-family-3d.png",      left: 37.4, top: 48.1, w: 16.0, cls: "hero" },
];
const D_ADULT = [
  { src: DA + "char-adult-doodle.png",   left: 66.4, top: 46.3, w: 14.8, cls: "hero" },
  { src: DA + "char-adult-3d.png",       left: 85.7, top: 45.9, w: 14.1, cls: "hero" },
];
const D_TAPE_ADULT  = { src: DA + "tape-adult.png",  left: 38.58, top: 5.99, w: 39.60 };
const D_TAPE_FAMILY = { src: DA + "tape-family.png", left: 25.11, top: 6.12, w: 24.89 };
...
function DoodleLayers({ coverBg, showSubtitle }) {
  return (
    <React.Fragment>
      ...
      <img className="white-paper" src={DA + "paper-white.png"} alt="" />
      ...
      <div className="kraft-layer">
        <div className="kraft-slide">
          <img className="kraft-paper" src={DA + "kraft-wide.png"} alt="" />
      ...
      <div className="layerbox title-layer">
        <img className="title-img" src={DA + "title.png"} alt="塗鴉變 3D 模型？！" />
        {showSubtitle &&
          <img className="subtitle-img" src={DA + "subtitle-clean-y56.png"} alt="零基礎用隨手 塗鴉+AI 創作出您的列印公仔" />}
      </div>
    </React.Fragment>
  );
}
...
const DOODLE_IMG = [
  DA+"paper-white.png", DA+"kraft-wide.png", DA+"title.png", DA+"subtitle-clean-y56.png",
  D_TAPE_ADULT.src, D_TAPE_FAMILY.src,
  ...D_FAMILY.map(s=>s.src), ...D_ADULT.map(s=>s.src),
  DA+"cover-family.png", DA+"cover-adult.png",
];
